...
function qode_styles() {
	...
	$fonts_array  = array(
						$qode_options_central['google_fonts'].':200,300,400',
						$qode_options_central['button_title_google_fonts'].':200,300,400',
						$qode_options_central['message_title_google_fonts'].':200,300,400',
						$qode_options_central['h1_google_fonts'].':200,300,400',
						$qode_options_central['page_title_google_fonts'].':200,300,400',
						$qode_options_central['h2_google_fonts'].':200,300,400',
						$qode_options_central['h3_google_fonts'].':200,300,400',
						$qode_options_central['h4_google_fonts'].':200,300,400',
						$qode_options_central['h5_google_fonts'].':200,300,400',
						$qode_options_central['h6_google_fonts'].':200,300,400',
						$qode_options_central['text_google_fonts'].':200,300,400',
						$qode_options_central['menu_google_fonts'].':200,300,400',
						$qode_options_central['dropdown_google_fonts'].':200,300,400',
						$qode_options_central['dropdown_google_fonts_thirdlvl'].':200,300,400'
	...
	if(count($fonts_array) > 0) :
		printf("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800|Oswald:400,300,700|%s&subset=latin,latin-ext' type='text/css' />\r\n", str_replace(' ', '+', $google_fonts_string));
	else :
		printf("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800|Oswald:400,300,700&subset=latin,latin-ext' type='text/css' />\r\n");
	endif;
...
function qode_scripts() {
	...
	if($qode_options_central['enable_google_map'] == "yes") :
	...
	if ($qode_options_central['page_transitions'] != "0")
		$has_ajax = true;
	...
	if($qode_options_central['use_recaptcha'] == "yes") :
...
add_image_size( 'blog-type-1', 600, 340, true );
...
function ajax_classes($classes) {
	...
	if($qode_options_central['page_transitions'] === "0") :
		$classes[] = '';
	elseif($qode_options_central['page_transitions'] === "1") :
		$classes[] = 'ajax_updown';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_central['page_transitions'] === "2") :
		$classes[] = 'ajax_fade';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_central['page_transitions'] === "3") :
		$classes[] = 'ajax_updown_fade';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_central['page_transitions'] === "4") :
...
function boxed_class($classes) {
	...
	if($qode_options_central['boxed'] == "yes") :
		$classes[] = 'boxed';
	else:
	$classes[] ="";
	endif;
...
function qode_excerpt_length( $length ) {
	global $qode_options_central;
	if($qode_options_central['number_of_chars']){
		 return $qode_options_central['number_of_chars'];
	} else {
		return 45;
	}
}
...
function the_excerpt_max_charlength($charlength) {
	global $qode_options_central;
	$via = $qode_options_central['twitter_via'];
