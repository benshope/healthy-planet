...
if (isset($qode_options_central['hide_contact_form_website'])) $hide_contact_form_website = $qode_options_central['hide_contact_form_website'];
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<?php
		...
		?>
	<?php if($qode_options_central['enable_google_map'] == "yes"){ ?>
	...
	<div class="container">
		<div class="container_inner clearfix">
			<div class="contact_detail">	
				...
				<?php if($qode_options_central['enable_contact_form'] == "yes"){ ?>
				<div class="two_columns_50_50 clearfix">
					<div class="column1">
						<div class="column_inner">
							<div class="contact_form">
								<h4><?php if($qode_options_central['contact_heading_above'] != "") { echo $qode_options_central['contact_heading_above'];  } else { ?><?php _e('Contact Form', 'qode'); ?><?php } ?></h4>										
								<form id="contact-form" method="post" action="">
									...
									if($qode_options_central['use_recaptcha'] == "yes") :
										...
										if($qode_options_central['recaptcha_public_key']) {
											$publickey = $qode_options_central['recaptcha_public_key'];
										} else {
											$publickey = "6Ld5VOASAAAAABUGCt9ZaNuw3IF-BjUFLujP6C8L";
										}
										if($qode_options_central['recaptcha_private_key']) {
											$privatekey = $qode_options_central['recaptcha_private_key'];
										} else {
										...
										<?php } ?>
										<p id="captchaHolder"><?php if($qode_options_central['page_transitions'] == "0"): echo recaptcha_get_html($publickey); endif;?></p>
