...
?>
    ...
    <?php if ( have_comments() ) : ?>
        <h2 class="comments-title <?php echo $wpGrade_Options->get('blog_single_show_comments_title') ? '' : 'hidden'?>">
            <?php
                printf( _n( '1 Response / Leave a comment', '%1$s Responses / Leave a comment', get_comments_number(), wpGrade_txtd ),  number_format_i18n(get_comments_number()));
            ?>
        </h2>
    ...
    $comments_args = array(
        ...
        'title_reply'=> __('Leave a comment', wpGrade_txtd ),
        ...
        'label_submit' => __('Submit', wpGrade_txtd),
