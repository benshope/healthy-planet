jQuery(document).ready(function ($) {
    ...
    $(".reset_google_font").on('click', function(){
        $(this).siblings('.font').val('');
        $(this).siblings('.font-select').children('a').children('span')
                .text('Select a font')
                .attr('style', '');
    });
});
...
(function($){
  ...
  $.fn.fontselect = function(options) {
    ...
    var settings = $.extend( {
      ...
      apiKey:          'AIzaSyB7Yj842mK5ogSiDa3eRrZUIPTzgiGopls',
      fetch:            true,
      combine:          false
    }, options);
