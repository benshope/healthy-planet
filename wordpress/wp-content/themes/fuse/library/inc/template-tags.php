...
function wpgrade_content_nav( $nav_id ) {
	...
	<?php if ( is_single() ) : // navigation links for single posts ?>
		<?php next_post_link( '<b class="portfolio-nav-prev">%link</b>', '<i class="shc icon-e-left-open-big"></i>' ); ?>
        <?php previous_post_link( '<b class="portfolio-nav-next">%link</b>', '<i class="shc icon-e-right-open-big"></i>' ); ?>
        <?php echo '<a class="portfolio-nav-archive" href="'.get_portfolio_page_link().'"><i class="icon-e-dot-3"></i></a>' ?>


	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>

		<?php if ( get_next_posts_link() ) : ?>
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&laquo;</span> Older posts', wpGrade_txtd ) ); ?></div>
		<?php endif; ?>

		<?php if ( get_previous_posts_link() ) : ?>
		<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&raquo;</span>', wpGrade_txtd ) ); ?></div>
		<?php endif; ?>
...
function wpgrade_comment( $comment, $args, $depth ) {
	...
	<li class="post pingback">
		<p><?php _e( 'Pingback:', wpGrade_txtd ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( '(Edit)', wpGrade_txtd ), ' ' ); ?></p>
	<?php
			break;
		default :
	?>
		...
		<article id="comment-<?php comment_ID(); ?>">
			<footer>
				<div class="comment-author vcard">
					...
					<?php printf( __( '%s', wpGrade_txtd ), sprintf( '<span class="fn">%s</span>', get_comment_author_link() ) ); ?>
				...
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<em><?php _e( 'Your comment is awaiting moderation.', wpGrade_txtd ); ?></em>
					<br />
				<?php endif; ?>
...
function wpgrade_posted_on() {
	printf( __( '<a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a>', wpGrade_txtd ),
		esc_url( get_permalink() ),
		esc_attr( get_the_time() ),
		esc_attr( get_the_date( 'c' ) ),
		esc_html( get_the_date( 'F d, Y' ) ),
		esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
		esc_attr( sprintf( __( 'View all posts by %s', wpGrade_txtd ), get_the_author() ) ),
