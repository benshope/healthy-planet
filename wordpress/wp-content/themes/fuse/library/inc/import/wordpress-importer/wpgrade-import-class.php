...
//				continue;
	...
	function import_theme_options($option_file)
	{
		...
		$theme_options = unserialize(trim(base64_decode($theme_options),'###'));

		if(is_array($theme_options) && isset($theme_options['redux-opts-backup']) && $theme_options['redux-opts-backup'] == '1') {
            update_option(WPGRADE_SHORTNAME."_options", $theme_options);
		}
	...
	function set_menus()
	{
		...
		$menu_conf = $wpGrade_Options->get('nav_menus');
