;(function($){
	...
	$(document).ready(function(){
		...
		var insert_content_into_editor = function ( content ){
			...
			var this_editor = tinyMCE.get('the_only_editor');
			console.log (this_editor);
			if( typeof this_editor === "undefined" ) { // text editor
				$('#the_only_editor').val( content );
				$('#the_only_editor').text( content );
...
//			console.log( tinyMCE.triggerSave() );
		...
		$(document).on('click', '#wpgrade_portfolio_editor_modal .close_modal_btn',function(e){
			...
			if( typeof tinymce.get('the_only_editor') === "undefined" ) { // text editor
				$('#the_only_editor').text( '' );
				$('#the_only_editor').val( '' );
			} else { // visual editor
