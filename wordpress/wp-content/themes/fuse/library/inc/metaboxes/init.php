    ...
    <div class="row-controls">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu row-versions">
                ...
                <li><a <?php if ( $type == '1' ) echo 'class="s_active"' ?> href="#" data-type="1"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v1.png"></a></li>
                <li><a <?php if ( $type == '2' ) echo 'class="s_active"' ?> href="#" data-type="2"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v2.png"></a></li>
                <li><a <?php if ( $type == '3' ) echo 'class="s_active"' ?> href="#" data-type="3"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v3.png"></a></li>
                <li><a <?php if ( $type == '4' ) echo 'class="s_active"' ?> href="#" data-type="4"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v4.png"></a></li>
                <li><a <?php if ( $type == '5' ) echo 'class="s_active"' ?> href="#" data-type="5"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v5.png"></a></li>
                <li><a <?php if ( $type == '6' ) echo 'class="s_active"' ?> href="#" data-type="6"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v6.png"></a></li>
                <li><a <?php if ( $type == '7' ) echo 'class="s_active"' ?> href="#" data-type="7"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v7.png"></a></li>
                <li><a <?php if ( $type == '8' ) echo 'class="s_active"' ?> href="#" data-type="8"><img src="<?php echo WPGRADE_LIB_URL ?>inc/metaboxes/images/row-versions/v8.png"></a></li>
