...
function portfolio_admin_script() {
    ...
    if ( 'portfolio' == $post_type ) {
        wp_enqueue_style( 'portfolio-admin-script', WPGRADE_LIB_URL . 'inc/metaboxes/css/portfolio.css' );
        wp_register_script( 'reveal-js', WPGRADE_LIB_URL . 'inc/metaboxes/js/reveal.js' );
        wp_enqueue_script( 'bootstrap-dropdown', WPGRADE_LIB_URL . 'inc/metaboxes/js/bootstrap-dropdown.js' );
        wp_enqueue_script( 'portfolio-admin-script', WPGRADE_LIB_URL . 'inc/metaboxes/js/portfolio-patterns.js', array( 'jquery', 'reveal-js', 'bootstrap-dropdown' ) );
    }
...
//        'show_on'    => array( 'key' => 'id', 'value' => array( 2, ), ), // Specific post IDs to display this metabox
    ...
    $meta_boxes[] = array(
        ...
        'title'      => __('Project Builder', wpGrade_txtd),
        ...
        'fields' => array(
            array(
                'name' => __('My row', wpGrade_txtd),
                'desc' => __('Row type', wpGrade_txtd),
                'id'   => WPGRADE_PREFIX . 'portfolio_rows',
